...
function getEncryptionKey(): Buffer {
  ...
  if (!process.env.NEXT_PRIVATE_DOCUMENT_PASSWORD_KEY && process.env.NODE_ENV === "production") {
    console.warn("[SECURITY] Using NEXTAUTH_SECRET as document encryption fallback. Set NEXT_PRIVATE_DOCUMENT_PASSWORD_KEY for production.");
  }
  const PURPOSE_SALT = "bf-fund-document-encryption-v1";
